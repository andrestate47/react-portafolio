...
export default function Home() {
  ...
  return (
    ...
    <div className={darkMode ? 'dark' : ''}>
      ...
      /* Encabezado */
      <Head>
        <title>Andres Figueroa Portafolio</title>
        ...
        <section className='min-h-screen'>
          ...
          <div className='text-center p-10'>
            ...
            <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto '>
              Software Ingeneri Front-end . join me down below and lets get crac
            </p>
          </div>
        ...
        <section>
          ...
          <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              ...
              <p>
                Creating a greats desings suited for your needs desings theory.
              </p>
              <h4 className='py-4 text-teal-600'>Desings tools I use</h4>
